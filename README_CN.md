...
- **2026-03-15** — 🔀 [通用 LLM 支持](#-替代模型组合)：任意 OpenAI 兼容 API 均可作为审查器，通过 [`llm-chat`](mcp-servers/llm-chat/) MCP 服务器。GLM、Kimi、LongCat、DeepSeek、MiniMax——无需 Claude 或 OpenAI API
